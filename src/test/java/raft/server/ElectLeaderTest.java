...
public class ElectLeaderTest {
    ...
    public void testInitTwoNode() throws Exception {
        ...
        cluster.clearClusterPreviousPersistentState();
        cluster.startCluster();
        TestingRaftCluster.TestingNode leader = cluster.waitLeaderElected();
        ...
        TestingRaftCluster.TestingNode follower = cluster.getNodeById(followerId);
    ...
    public void testInitTripleNode() throws Exception {
        ...
        for (String id : followerIds) {
            TestingRaftCluster.TestingNode follower = cluster.getNodeById(id);
            follower.waitBecomeFollower(2000);
