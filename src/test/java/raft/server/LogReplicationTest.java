...
public class LogReplicationTest {
    ...
    public void testProposeOnSingleNode() throws Exception {
        ...
        TestingRaftCluster.TestingNode leader = cluster.waitLeaderElected(2000);
        ...
        List<LogEntry> applied = leader.drainAvailableApplied();
    ...
    private static void checkAppliedLogs(TestingRaftCluster.TestingNode node, int logCount, List<byte[]> sourceDataList) {
    ...
    public void testProposeOnTripleNode() throws Exception {
        ...
        cluster.clearClusterPreviousPersistentState();
        cluster.startCluster();
        TestingRaftCluster.TestingNode leader = cluster.waitLeaderElected(5000);
        ...
        for (String id : followerIds) {
            TestingRaftCluster.TestingNode node = cluster.getNodeById(id);
