...
////        assertTrue(log.followerAsyncAppend(prevIndex, initTerm, prevIndex + entries.size(), entries) > 0);
//    }
//
//    /**
...
////        log.followerAsyncAppend(prevIndex, initTerm, prevIndex + entries.size(), entries);
//    }
//
//    /**
